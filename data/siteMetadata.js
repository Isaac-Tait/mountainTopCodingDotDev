...
const siteMetadata = {
  title: 'mountainTopCoding(🏔);',
  author: 'Isaac Tait',
  headerTitle: 'JAMstack developer portfolio',
  description:
    'Isaac Tait - normative ideology challenging, Buddhist, activist, queer, & exvangelical',
  language: 'en-us',
  theme: 'system', // system, dark or light
  siteUrl: 'https://mountaintopcoding.dev',
  siteRepo: 'https://github.com/Isaac-Tait/mountainTopCodingDotDev',
